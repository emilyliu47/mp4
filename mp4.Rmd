...
top_10_visits <- function(demographic, demo_type) { #this function takes in a tally of  start and end station visits for a demographic (two tables), and outputs one table that is the 10 most visited (start and end) stations for the demographic
